...
} - 1 < navigator.platform.indexOf("Win") ? (new PerfectScrollbar(".wrapper .login-page, .register-page, .card"), 0 != jQuery(".tab-content .table-responsive").length && jQuery(".table-responsive").each(function () {
